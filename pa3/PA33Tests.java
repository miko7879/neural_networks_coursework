...
public class PA33Tests {
    ...
    public static void main(String[] arguments) {
        ...
        try {
            ...
            testRegularization(10, ActivationType.RELU, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(32, ActivationType.RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(43, ActivationType.LEAKY_RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);

            batchSize = 3;

            testRegularization(110, ActivationType.RELU, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(332, ActivationType.RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(443, ActivationType.LEAKY_RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);

            batchSize = 1;
            sizeZ = 3;
            testRegularization(112, ActivationType.RELU, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(334, ActivationType.RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(445, ActivationType.LEAKY_RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);

            batchSize = 3;
            testRegularization(11220, ActivationType.RELU, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(33442, ActivationType.RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
            testRegularization(44553, ActivationType.LEAKY_RELU5, batchSize, sizeZ, sizeY, sizeX, checkGradients, useDropout, dropoutRate, useBatchNormalization, alpha);
