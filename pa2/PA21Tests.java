...
public class PA21Tests {
    ...
    public static RecurrentNeuralNetwork createOneLayerRNN(String rnnName, DataSet dataSet, RNNNodeType nodeType, String networkType, LossFunction lossFunction) {
        ...
        try {
            ...
            } else if (nodeType == RNNNodeType.DELTA) {
                expectedWeights = (nInputs * HIDDEN_LAYER_SIZE) /*input to hidden*/ + (6 * HIDDEN_LAYER_SIZE) /*Delta hidden weights/bias*/ + HIDDEN_LAYER_SIZE * nOutputs /*hidden to output*/ + (6 * nOutputs); /*weights/biases for outputs*/
            } else {
    ...
    public static RecurrentNeuralNetwork createTwoLayerRNN(String rnnName, DataSet dataSet, RNNNodeType nodeType, String networkType, LossFunction lossFunction) {
        ...
        try {
            ...
            if (nodeType == RNNNodeType.LSTM) {
                ...
                expectedWeights = (nInputs * HIDDEN_LAYER_SIZE) /*input to hidden1*/ + (HIDDEN_LAYER_SIZE * HIDDEN_LAYER_SIZE) /*hidden1 to hidden2*/ + (9 * HIDDEN_LAYER_SIZE) /*hidden bias 1*/ + (9 * HIDDEN_LAYER_SIZE) /*hidden bias 2*/ + HIDDEN_LAYER_SIZE * nOutputs /*hidden2 to output*/ + (9 * nOutputs); /*weights for GRU outputs*/
            } else if (nodeType == RNNNodeType.DELTA) {   
                expectedWeights = (nInputs * HIDDEN_LAYER_SIZE) /*input to hidden1*/ + (HIDDEN_LAYER_SIZE * HIDDEN_LAYER_SIZE) /*hidden1 to hidden2*/ + (6 * HIDDEN_LAYER_SIZE) /*hidden bias 1*/ + (6 * HIDDEN_LAYER_SIZE) /*hidden bias 2*/ + HIDDEN_LAYER_SIZE * nOutputs /*hidden2 to output*/ + (6 * nOutputs); /*weights for GRU outputs*/
            } else {
